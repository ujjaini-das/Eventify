...
router.post("/", protect, authorizeRoles("organiser", "admin"), upload.single("image"), createEvent);
router.patch("/:id", protect, authorizeRoles("organiser", "admin"),upload.single("image"),updateEvent);
